...
import { personalBlogService } from '@/app/services/personalBlogService'
import {
    Box,
    Button,
    CircularProgress,
...
import { PersonalBlogTableContainerStyled } from '../styled/PersonalBlogTableContainerStyled'
import { useRouter } from 'next/router'
import { PersonalBlogEditorModal } from '../../PersonalBlogEditor/ui/PersonalBlogEditorModal'

export const PersonalBlogTable = () => {
    ...
    const fetchPosts = useCallback(() => {
        ...
        const q = query(ref(db, '/personal-blog'))
    ...
    const handleDeleteConfirm = async () => {
        ...
        setIsDeleting(true)
        try {
            await personalBlogService.deletePost(deletingPost.key)
    ...
    return posts == undefined ? (
        ...
        <Grid item sm={12}>
            <PersonalBlogTableContainerStyled component={Paper}>
                <Table aria-label="simple table">
                    ...
                    <TableBody>
                        {sortedPosts?.map((post) => (
                            <TableRow
                                onClick={() => {
                                    router.push(`/personal-blog/${post.data.src}`)
                                }}
                                key={post.key}
                                sx={{
            ...
            </PersonalBlogTableContainerStyled>
